...
#' @param save.basis.fns A Boolean specifying whether or not the estimated basis function matrix \eqn{\Phi} and the \emph{k}-means results used to create it should be saved to the unstructured metadata of \code{sp.obj}. Defaults to FALSE.
#' @details
#' \itemize{
