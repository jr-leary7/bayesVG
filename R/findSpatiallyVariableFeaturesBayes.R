...
#' @param save.model A Boolean specifying whether or not the fitted model generated by \code{\link[cmdstanr]{cmdstan_model}} should be saved to the unstructured metadata of \code{sp.obj}. In addition, the estimated log-likelihood and Bayesian information criterion (BIC) of the model will be saved to the same slot. Defaults to FALSE.
#' @details
#' \itemize{
