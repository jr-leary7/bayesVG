...
#' @param n.chains (Optional) An integer specifying the number of chains used when fitting the model via sampling instead of VI or the Laplace approximation. Defaults to 1.
#' @param thin.rate (Optional) An integer specifying the thinning rate of the MCMC NUTS algorithm when sampling is being used instead of VI or the Laplace approximation. Defaults to 5.
