...
#' @name extractModel 
#' @author Jack R. Leary
#' @description This function extracts the fitted model from \code{brms} or \code{cmdstanr} (depending on whether you're identifying HVGs or SVGs) from the user-provided \code{Seurat} or \code{SingleCellExperiment} object to which the model has been written. 
#' @param obj The \code{Seurat} or \code{SingleCellExperiment} whose unstructured metadata contains the fitted model. Defaults to NULL. 
