...
2. Burkner, P. [Bayesian Item Response Modeling in R with brms and Stan](https://www.jstatsoft.org/v100/i05/). *Journal of Statistical Software* (2021). 

3. Gabry, J. *et al*. [cmdstanr: R Interface to CmdStan](https://mc-stan.org/cmdstanr/). (2024). 

4. Rasmussen, C. and Williams, C. [Gaussian Processes for Machine Learning](https://direct.mit.edu/books/book/2320/Gaussian-Processes-for-Machine-Learning). *The MIT Press* (2005).
...
6. Carpenter, B. *et al*. [Stan: A Probabilistic Programming Language](http://www.jstatsoft.org/v76/i01/). *Journal of Statistical Software* (2017). 
